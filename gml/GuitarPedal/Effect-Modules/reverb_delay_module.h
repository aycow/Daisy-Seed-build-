...
// Change from 8 seconds to 2 seconds
#define MAX_DELAY static_cast<size_t>(48000.0f * 2.f)        // 2 second max delay
#define MAX_DELAY_REV static_cast<size_t>(48000.0f * 2.f)    // 2 second max delay
#define MAX_DELAY_SPREAD static_cast<size_t>(4800.0f)        // Keep at 50 ms
